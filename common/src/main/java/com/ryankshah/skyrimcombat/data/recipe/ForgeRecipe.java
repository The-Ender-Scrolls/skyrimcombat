package com.ryankshah.skyrimcombat.data.recipe;

import com.ryankshah.skyrimcombat.block.inventory.BlankRecipeInput;
    ...
    public static class Builder {
        ...
        public Builder addRecipeItem(ItemStack stack) {
            if(this.recipeItems.contains(stack))
                ...
                this.recipeItems.add(Ingredient.of(stack.getItem()));
                return this;
            }
        }
